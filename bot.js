...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'eyas4gamer')) {
    if (!devs.includes(message.author.id)) return; 
...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **eyas4gamer bot !**  A Nice Bot Developed By:`MHSTR`')
...
var v1 = new Discord.RichEmbed()
  ...
  v1.setFooter("# | eyas4gamer  TeaM |")
var heroo = new Discord.RichEmbed()
.setColor('#6a109d')
.setTimestamp(new Date())
.setThumbnail(client.user.avatarURL)
.setTitle('eyas4gamer  Bot Info')
